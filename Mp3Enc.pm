...
POE::Component::Mp3Enc - POE Component for running notlame, an mp3 encoder.

=head1 SYNOPSIS

use POE qw(Component::Mp3Enc);

$mp3 = POE::Component::Mp3Enc->new($bitrate => 160);
$mp3->enc("/tmp/tst.wav");
...
This POE component encodes raw audio files into mp3 format.  It is merely a wrapper for the B<notlame> program.
